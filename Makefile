...
java-run: ## run the jar
	export SIMPLE_SERVICE_DOWNSTREAM_SERVICES=http://localhost:8080,http://localhost:8080; export SIMPLE_SERVICE_EXIT_LIKELY=7; java -jar target/simpleservice-0.0.1.jar
